...
function admin_menu_tree_page_view_admin_init() {
	wp_enqueue_style('admin_menu_tree_page_view_styles', plugins_url('/css/styles.css', __FILE__), array(), '2.7.4');
    ...
    wp_enqueue_script('jquery-cookie', plugins_url('/js/jquery.biscuit.js', __FILE__), array('jquery'));
    ...
    wp_add_inline_script('admin_menu_tree_page_view', 'const amtpv_l10n = ' . json_encode(array(
