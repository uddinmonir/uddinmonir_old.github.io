...
if ( ! class_exists( 'wp_website_map_free_class' ) ) :

  class wp_website_map_free_class {//////////USE YOUR OWN CLASS NAME//////////
	...
	public $file_version = 3.1;//
	/* * * * * * * * * *
    * Class constructor
    * * * * * * * * * */
    public function __construct() {
		///////////////////THIS MUST BE CHANGED FOR EACH PLUGIN BEGIN////////////////
		$this->notify_array_data["plugin_real_slug"] = "tree-website-map";
		$this->notify_array_data["variable_slug"] = "wp_website_map_free_class_";// Use your own prefix
		$this->notify_array_data["message_header"] = __( 'Leave A Review?', $this->notify_array_data["plugin_real_slug"]);// Use your own prefix
		$this->notify_array_data["message_body"] = __( 'We hope you\'ve enjoyed using tree page view plugin :), Would you mind taking a few minutes to write a review on WordPress.org?<br>Just writing simple "thank you" will make us happy!', $this->notify_array_data["plugin_real_slug"]);// Use your own prefix
...
//Call all that work
new wp_website_map_free_class(); //////////MUST BE RIGHT OBJECT SAME AS CLASS NAME//////////
?>